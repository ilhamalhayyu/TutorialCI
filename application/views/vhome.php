...
<html lang="en">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
				<link rel="icon" href="<?php base_url('i/favicon.png')?>" type="image/x-icon">
		<!-- Google Fonts -->
...
<link rel="stylesheet" href="<?php base_url('assets/homepage/font.css')?>">
        <!-- Bootstrap 4.3.1 CSS -->
		<!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php base_url('assets/homepage/bootstrap.min.css')?>">

    <!-- Slick 1.8.1 jQuery plugin CSS (Sliders) -->
		<!-- <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css"/> -->
    <link rel="stylesheet" href="<?php base_url('assets/homepage/slick.css')?>">

    <!-- Fancybox 3 jQuery plugin CSS (Open images and video in popup) -->
		<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css" /> -->
    <link rel="stylesheet" href="<?php base_url('assets/homepage/jquery.fancybox.min.css')?>">

		<!-- AOS 2.3.1 jQuery plugin CSS (Animations) -->
		<!-- <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="<?php base_url('assets/homepage/aos.css')?>">

		<!-- FontAwesome CSS -->
		<!-- <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php base_url('assets/homepage/all.css')?>">

    <!-- Startup 3 CSS (Styles for all blocks) -->
					<link href="<?php base_url('assets/homepage/css/style.css')?>" rel="stylesheet" />
				<!-- jQuery 3.3.1 -->
		<!-- <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script> -->
     <script src="<?php base_url('assets/homepage/jquery-3.3.1.min.js')?>"></script>
	...
	<div class="container px-xl-0">
		<div class="row align-items-center align-items-lg-start">
			...
			<div class="col-lg-5 col-md-4" data-aos-duration="600" data-aos="fade-down" data-aos-delay="300">
				<img srcset="<?php base_url('assets/i/feature_44_img_1@2x.png 2x')?>" src="<?php base_url('assets/i/feature_44_img_1.png')?>" class="img" alt="" />
			</div>
		</div>
...
<script src="<?php base_url('assets/homepage/bootstrap.bundle.min.js')?>"></script>
<!-- Fancybox 3 jQuery plugin JS (Open images and video in popup) -->
<!-- <script src="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js"></script> -->
<script src="<?php base_url('assets/homepage/jquery.fancybox.min.js')?>"></script>

<!-- Google maps JS API -->
<!-- <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyDP6Ex5S03nvKZJZSvGXsEAi3X_tFkua4U"></script> -->
<script src="<?php base_url('assets/homepage/maps.js')?>"></script>

<!-- Slick 1.8.1 jQuery plugin JS (Sliders) -->
<!-- <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script> -->
<script src="<?php base_url('assets/homepage/slick.min.js')?>"></script>

<!-- AOS 2.3.1 jQuery plugin JS (Animations) -->
<!-- <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script> -->
<script src="<?php base_url('assets/homepage/aos.js')?>"></script>

<!-- Maskedinput jQuery plugin JS (Masks for input fields) -->
<script src="<?php base_url('assets/homepage/jquery.maskedinput.min.js')?>"></script>
<!-- Startup 3 JS (Custom js for all blocks) -->
<script src="<?php base_url('assets/homepage/script.js')?>"></script>
